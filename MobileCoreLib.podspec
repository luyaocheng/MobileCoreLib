#
#  Be sure to run `pod spec lint MobileCoreLib.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/luyaocheng/MobileCoreLib"
  ...
  s.author             = { "luyaocheng" => "luyaocheng@gmail.com" }
  # Or just: s.author    = "luyaocheng"
  # s.authors            = { "luyaocheng" => "luyaocheng@gmail.com" }
  # s.social_media_url   = "http://twitter.com/luyaocheng"
